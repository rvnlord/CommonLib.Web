...
{
    public class AddRoleBase : MyComponentBase
    {
        ...
        protected AdminEditRoleVM _adminAddRoleVM { get; set; }
        ...
        {
            _adminAddRoleVM = new();
            _editContext = new MyEditContext(_adminAddRoleVM);
            _users = new();
        ...
        public async Task BtnAddRole_ClickAsync(MyButtonBase sender, MouseEventArgs e, CancellationToken token)
        {
            ...
            var editResponse = await AdminClient.AddRoleAsync(_adminAddRoleVM);
            ...
            Mapper.Map(editResponse.Result, _adminAddRoleVM);
        ...
        {
            if (isChecked)
                _adminAddRoleVM.UserNames.Add(user.UserName);
            else
                _adminAddRoleVM.UserNames.Remove(user.UserName);
